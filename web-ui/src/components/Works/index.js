...
const Works = ({ projects, toggle, mobileToggle, clearFilters, filters, photoFilter, audioFilter, projectFilter, studyFilter, fabricFilter }) => {
  ...
  const p44 = { type: "me", link: "", name: "Austin Emmanuel Kim", semester: "∞", desc: "1/2 of Living Skin. Designer, Scientist, Artist, The Wandering Bateman, Photographer, Experiential Advisor, Blogger, Curator, 호연, Owner of this Archive.", imgs: ["fun/me2.png"], tags: ["me"]};
  ...
  const p4 = { type: "event", name: "The Lunchables Experience", link: "", semester: "june 11th 2023", desc: "A curated, multi-layered food experience based around the american-staple food product: Lunchables.", imgs: [ "projects/lunch15.jp2", "projects/lunch.jp2", "projects/lunch1.jp2", "projects/lunch2.jp2", "projects/lunch3.jp2", "projects/lunch4.jp2", "projects/lunch5.jp2", "projects/lunch6.jp2", "projects/lunch7.jp2", "projects/lunch8.jp2", "projects/lunch9.jp2", "projects/lunch10.jp2", "projects/lunch11.jp2", "projects/lunch12.jp2", "projects/lunch13.jp2", "projects/lunch14.jp2"], tags: ["Performance Art", "Experience Design"]};
  const p5 = { type: "study", isCS: true, link: "https://junehomes.com/residences/new-york-city-ny/upper-west-side/363-west-harlem/937", name: "June Homes Apartment Page Redesign", semester: "winter 2022'", desc: "Large restructuring of June’s Apartment Page and booking system, two closely tied systems. June Home's Apartment Page was outdated, lacking in details about their reservation, and not tailored to reservation processes.", imgs: ["work/june/1_cover.jpg", "work/june/1_11.jpeg", "work/june/1_12.jpeg", "work/june/1_14.jpeg", "work/june/1_1.jpeg", "work/june/1_2.jpeg", "work/june/1_3.jpeg", "work/june/1_7.jpeg", "work/june/1_8.jpeg", "work/june/1_9.jpeg", "work/june/1_10.jpeg"], tags: ["Figma", "UX Design"]};
  ...
  const p56 = { type: "project", name: "Living Skin", link: "https://livingskin.space", semester: "oct 2023", desc: "Project space and persons hub based in Bushwick, NY.", imgs: ["work/livingskin/space1.jp2", "work/livingskin/space0.jp2", "work/livingskin/space.jpeg", "work/livingskin/space2.jp2", "work/livingskin/space3.jpeg", "work/livingskin/space5.jpeg", "work/livingskin/space4.jpeg", "work/livingskin/space7.jpeg"], tags: ["obsidian"]};
  ...
  const p71 = { type: "photo", name: "Tea Archives", link: "", semester: "2024", desc: "Snippets from my daily practices. 2024. Various puerh.", imgs: ["photo/tea/1.jp2", "photo/tea/2.jp2", "photo/tea/3.jp2", "photo/tea/4.jp2", "photo/tea/5.jp2", "photo/tea/6.jp2", "photo/tea/7.jp2", "photo/tea/8.jp2", "photo/tea/9.jp2", "photo/tea/10.jp2", "photo/tea/11.jp2"], tags: ["film", "yashica samurai", "photo"]};
  ...
  const p73 = { type: "event", name: "Semi-Permeable: Meditations on Membranes, Remembrance, and Mending", link: "https://livingskin.space/semi-permeable", semester: "august 2024", desc: "Group show at Living Skin, curated by Rose Malenfant and Leah Huang: 'How do we inherit memory, and how do we trust, disrupt or inform it? How do we distill truth from our consumption? And how do we move from a source of care, not survival?'", imgs: ["events/sp9.jp2", "events/sp11.jp2", "events/sp0.jp2", "events/sp7.jp2", "events/sp3.jp2", "events/sp5.jp2", "events/sp10.jp2", "events/sp8.jp2", "events/sp6.jp2", "events/sp2.jp2", "events/sp1.jp2", "events/sp4.jp2"], tags: ["film", "yashica samurai", "photo"]};
  const p74 = { type: "project", name: "Show Flyers", link: "", semester: "+2024", desc: "Commissioned graphics, flyers, promotional materials for exhibitions and shows at Living Skin.", imgs: ["graphic/flyer.png", "graphic/flyer0.png", "graphic/flyer1.jp2", "graphic/flyer2.png", "graphic/flyer3.jpg", "graphic/flyer4.jpg", "graphic/flyer5.png", "graphic/flyer6.jpg", "graphic/flyer7.jp2", "graphic/flyer8.jp2", "graphic/flyer9.jpg"], tags: ["film", "yashica samurai", "photo"]};
  const p75 = { type: "study", name: "L.S. Brand Design", link: "", semester: "dec 2023", desc: "Brand Design for gallery in Brooklyn, NY.", imgs: ["graphic/lb.png", "graphic/lb0.jpg", "graphic/lb1.png", "graphic/lb2.png", "graphic/lb3.jp2", "graphic/lb4.jpg", "graphic/lb5.jpg", "graphic/lb6.jpg", "graphic/lb7.png", "graphic/lb8.png"], tags: ["film", "yashica samurai", "photo"]};

  const myProjects = [ p44, p56, p59, p62, p48, p58, p5, p11, p75, p73, p61, p63, p74, p70, p69, p65, p64, p57, p68, p66, p67, p1, p3, p47, p72, p55, p20, p6, p71, p53, p49, p52, p4, p2, p10, p35, p40, p16, p18, p9, p19, p22, p25, p12, p24, p32, p36, p34];
  ...
  return (
    <Container>
      <FiltersContainer>
        ...
        <Filter onClick={fabricFilter} active={(filters.includes("event")) ? true : false }>events <a>{(filters.includes("event")) ? " ✕" : ""}</a></Filter>
      </FiltersContainer>
