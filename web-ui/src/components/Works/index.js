...
const Works = ({ projects, toggle, mobileToggle, clearFilters, filters, photoFilter, audioFilter, projectFilter, caseFilter, fabricFilter }) => {
  ...
  const p13 = { type: "case", isCS: false, link: "http://v1.austinkim.works/1/works", name: "YvStudio: Art Teacher Website Design", semester: "fall 2021", desc: "A free-lance project for a local high school art teacher, Yvette Kim. The website will be a showcase for her and her student's work, as well as being a 'sustainable' site for her to add and remove content directly on the website.", imgs: ["projects/yvette.jpeg"], tags: ["Figma", "Web Design", "Experience Design", "React.js"]};
  ...
  const p35 = { type: "case", link: "http://v1.austinkim.works/3/works", name: "Data Privacy Campaign", semester: "fall 2019", desc: "A Data Privacy Campaign is a project aimed at bringing awareness to data privacy, and the dangers surrounding it. Social media corporations are always watching, always collecting data on user’s habits. Final deliverable: website design mockup, series of Instagram Advertisements, series of posters, laptop and phone stickers, and business cards.", imgs: ["graphic/privacy.jpeg"], tags: ["InDesign", "Illustrator", "Graphic Design"]};
  ...
  const p44 = { type: "me", link: "", name: "Austin Kim, nektine", semester: "∞", desc: "Designer, Developer, Lover of type, Photographer, Experiential Advisor, Ableton Lover, Blogger (about stupid stuff and songs I appreciate), Curator, Owner of this Archive.", imgs: ["fun/me.jpeg"], tags: ["me"]};
  ...
  const myProjects = [ p44, p48, p1, p6, p3, p49, p2, p4, p5, p47, p7, p8, p10, p35, p11, p12, p40, p13, p14, p15, p16, p17, p18, p24, p19, p20, p21, p31, p9, p22, p23, p25, p26, p27, pX7, p28, p29, p30, p32, p33, p36, p37, p38, p39, p43, p46, p42, p34, p41, p45 ];
