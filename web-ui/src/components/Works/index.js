...
const Works = ({ projects, toggle, mobileToggle, clearFilters, filters, photoFilter, audioFilter, projectFilter, caseFilter, fabricFilter }) => {
  ...
  const p3 = { type: "case", name: "Work Portfolio V2 (v2.austinkim.works)", link: "http://v2.austinkim.works"s, semester: "spr 2023", desc: "Second version of my digital portfolio, holding more of my polished work more catered to the professional.", imgs: ["portfolio/v2.jpeg"], tags: ["Figma", "React", "Elixir"]};
